...
import { MenuItem, InputGroup, DropdownButton, Image, Col, Row,
  Well, Panel, FormGroup, FormControl, ControlLabel, Button } from 'react-bootstrap';
        ...
        <Row>
          ...
          <Col xs={12} sm={6}>
            <Panel>
              ...
              <FormGroup controlId="discount" validationState={this.props.validation}>
